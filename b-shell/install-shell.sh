...
for i in $HOME/.bashrc $HOME/.bash_profile $HOME/.dir_colors $HOME/.inputrc $HOME/.bash_alias.sh $HOME/.bash_env.sh; do [ -e $i ] && [ ! -L $i ] && mv $i $shellbak/; done
for i in $HOME/.bashrc $HOME/.bash_profile $HOME/.dir_colors $HOME/.inputrc $HOME/.bash_alias.sh $HOME/.bash_env.sh; do [ -L $i ] && unlink $i ; done
