...
for i in $HOME/.gitconfig $HOME/.gitignore $HOME/.ackrc; do [ -e $i ] && [ ! -L $i ] && mv $i $othresbak/$i; done
for i in $HOME/.gitconfig $HOME/.gitignore $HOME/.ackrc; do [ -L $i ] && unlink $i ; done
