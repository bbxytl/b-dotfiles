...
" Bdot_CUSTOM
if !exists("g:go_highlight_bdot_brace")
  let g:go_highlight_bdot_brace = 0
endif

if !exists("g:go_highlight_bdot_custom_type_ts")
  let g:go_highlight_bdot_custom_type_ts = 0
endif
...
" Bdot_CUSTOM
  ...
  syntax match Bdotoperation display "[\[\]]"
  " 过滤注释
  syntax match Bdotoperation display "/[^/*]"me=e-1
  syntax match Bdotoperation display "*[^/]"me=e-1
  syntax match Bdotoperation display "*$"
  syntax match Bdotoperation display "/$"
